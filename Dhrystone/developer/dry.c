...
float dhrystone_integer_test()
{
  ...
  *argv = malloc(sizeof(char) * 15);
  ...
  strcpy(*argv, "dhrystone integer test");
  argv++;
  *argv = malloc(sizeof(char) * 15);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "100000000");
  argv--;

  dhrystone_solve(argc, argv, &dhrystones_per_second);
...
int dhrystone_solve(int argc, char *argv[], float *dhrystones_per_second)
/*****/
