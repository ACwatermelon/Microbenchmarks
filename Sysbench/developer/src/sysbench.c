...
void sb_report_cumulative(sb_stat_t *stat)
{
  ...
  sb_globals.events_avg = events_avg;
...
// {
//   double bandwith;
//   bandwith = sysbench_memory_write_test();
//   return 0;
// }

double sysbench_threads_test()
{
  int rc;
  int argc = 6;
  double events_avg = 0;
  char **argv;
  double *bandwith = malloc(sizeof(double));
  *bandwith = 0;

  argv = malloc(argc * sizeof(char *));
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "sysbench");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "threads");
  ...
  *argv = malloc(sizeof(char) * 20);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--threads=32");
  argv++;
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--thread_yields=1000");
  argv++;
  *argv = malloc(sizeof(char) * 20);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--thread-locks=8");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "run");
  ...
  sysbench_solve(argc, argv);
  events_avg = sb_globals.events_avg;

  free(argv);
  return events_avg;
}

double sysbench_memory_read_test()
{
  double bandwith = 0;
  int argc = 6;
  char **argv;
  ...
  *argv = malloc(sizeof(char) * 10);
  ...
  strcpy(*argv, "memory");
  argv++;
  *argv = malloc(sizeof(char) * 30);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--memory-block-size=4k");
  argv++;
  *argv = malloc(sizeof(char) * 30);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--memory-total-size=100g");
  argv++;
  *argv = malloc(sizeof(char) * 30);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--memory-oper=read");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "run");
  ...
  sysbench_solve(argc, argv);
  bandwith = sb_globals.memory_read_bandwith;
  free(argv);

  return bandwith;
}

double sysbench_memory_write_test()
{
  double bandwith = 0;
  int argc = 6;
  char **argv;
  ...
  *argv = malloc(sizeof(char) * 10);
  ...
  sysbench_solve(argc, argv);
  bandwith = sb_globals.memory_write_bandwith;
...
int IO_prepare()
{
  ...
  *argv = malloc(sizeof(char) * 10);
  ...
  strcpy(*argv, "fileio");
  argv++;
  *argv = malloc(sizeof(char) * 15);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-num=1");
  argv++;
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-total-size=100M");
  argv++;
  *argv = malloc(sizeof(char) * 30);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-extra-flags=direct");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "prepare");
...
double IO_rnd_read_run()
{
  ...
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-block-size=4k");
  argv++;
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-total-size=100M");
  ...
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-io-mode=async");
  argv++;
  *argv = malloc(sizeof(char) * 30);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-extra-flags=direct");
  ...
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-test-mode=rndrd");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "run");
  ...
  sysbench_solve(argc, argv);
  iops = sb_globals.fileio_read_iops;
...
double IO_rnd_write_run()
{
  ...
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-test-mode=rndwr");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "run");
  ...
  sysbench_solve(argc, argv);
  iops = sb_globals.fileio_write_iops;
...
double IO_seq_read_run()
{
  ...
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-test-mode=seqrd");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "run");
  ...
  sysbench_solve(argc, argv);
  bandwith = sb_globals.fileio_read_bandwith;
...
double IO_seq_write_run()
{
  ...
  *argv = malloc(sizeof(char) * 25);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "--file-test-mode=seqwr");
  argv++;
  *argv = malloc(sizeof(char) * 10);
  memset(*argv, '\0', sizeof(*argv));
  strcpy(*argv, "run");
  ...
  sysbench_solve(argc, argv);
  bandwith = sb_globals.fileio_write_bandwith;
...
double sysbench_IO_rnd_read_test()
{
  double iops = 0;

  IO_prepare();
  iops = IO_rnd_read_run();
  IO_cleanup();

  return iops;
}

double sysbench_IO_rnd_write_test()
{
  double iops = 0;

  IO_prepare();
  iops = IO_rnd_write_run();
  IO_cleanup();

  return iops;
}

double sysbench_IO_seq_read_test()
{
  double bandwith = 0;

  IO_prepare();
  bandwith = IO_seq_read_run();
  IO_cleanup();

  return bandwith;
}

double sysbench_IO_seq_write_test()
{
  double bandwith = 0;

  IO_prepare();
  bandwith = IO_seq_write_run();
  IO_cleanup();

  return bandwith;
}

int sysbench_solve(int argc, char *argv[])
{
  sb_test_t *test = NULL;
  int rc;
