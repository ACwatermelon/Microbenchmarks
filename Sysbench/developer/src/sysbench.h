...
typedef struct
{
  ...
  double          memory_read_bandwith;/* memory test measure*/
  double          memory_write_bandwith;
  double          fileio_read_bandwith;
  double          fileio_write_bandwith;
  double          fileio_read_iops;
  double          fileio_write_iops;
  double          events_avg;/*threads test measure*/
} sb_globals_t;
